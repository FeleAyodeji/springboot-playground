...
public class StudentController {
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student("umesh", "Fadatare" ,2 ));
        students.add(new Student("Ram", "Jadhav" , 3));
        students.add(new Student( "Sanjay", "Pawar" , 4));
...
//        Student student = new Student("Gbemi" , "Olaosebikan" ,1);
//        return student;
//    }
//
//    @GetMapping("/students")
...
//        List<Student> students = new ArrayList<>();
//            students.add(new Student("Gbemi" , "Olaosebikan" ,1));
//            students.add(new Student("Ayo" , "Fele" ,2));
//            return students;
//
//    }
//
...
//        return new Student("gbemisola" , "Olaosebikan" , id);
//    }
//}
